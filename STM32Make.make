...
GCC_PATH="C:/ARM_GNU/12.3 REL1/BIN
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"D:/TOOL/XPACK-OPENOCD-0.12.0-1-WIN32-X64/XPACK-OPENOCD-0.12.0-1/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"D:/TOOL/XPACK-OPENOCD-0.12.0-1-WIN32-X64/XPACK-OPENOCD-0.12.0-1/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f1x mass_erase 0; exit"
